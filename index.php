<html>
  <head>
	...
	<script src="webgl-demo.php" type="text/javascript"></script>
...
foreach(glob("./dataDir/satellitePositions/*.txt") as $filename){
	...
	<table style="width:100%;height:100%;">
		...
		<tr>
                        ...
                        <th>
                                ...
                                <div class="toggleOptionsButtons" id="autoReloadButton" onclick="autoReload = !autoReload;if(autoReload){$(this).css({color:'#662255'});refreshAt(55);}else{$(this).css({color:'#222222'});clearTimeout(autoReloadEventCall);}updateHashLink('autoReload', autoReload);">Auto Reload</div>
		...
		<tr style="height:5%;">
			<td colspan="2">
				<table style="width:100%;height:100%;margin:0;padding:0;">
					<tr>
						<td class="settingsButtons" id="rocketModeButton" onclick="rocketMode = !rocketMode;if(rocketMode){startRocketMode();}else{stopRocketMode();}"></td>
						<td class="settingsButtons" onclick="window.location.href='//qcweb.ssec.wisc.edu/wxsats/';">Reset</td>
						<td class="settingsButtons" onclick="selfDestruct=true;$('#settingsBox').hide('clip');$(this).hide('highlight', {color:'red'});$('#rocketModeButton').hide();stopRocketMode();"></td>
					</tr>
				</table>
			</td>
		</tr>
